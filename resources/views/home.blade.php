        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 text-right">
                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addTodoModal">Add Todo</button>
                </div>
            </div>
...
<div class="modal fade" id="addTodoModal" aria-hidden="true" tabindex="-1">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        ...
                        <span id="taskError" class="alert-messgae"></span>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="editTodoModal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input typep="hidden" name="todo_id" id="todo_id">
                <div class="form-group">
                    <label for="name" class="col-sm-2">Task</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="edittask" name="todo" placeholder="Edit Task">
